...
pub mod testbed {
    ...
    pub mod compute {
        ...
        pub fn create_main_pipeline_from_path(
            ...
            let module = super::create_shader_module_from_path(device, shader_defs).unwrap();
            let layout = super::create_pipeline_layout(device);
            device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
                label: Some("Compute Pipeline main"),
                layout: Some(&layout),
...
"#;
    pub fn load_shader_modules_embedded(
        ...
        composer
            .add_composable_module(naga_oil::compose::ComposableModuleDescriptor {
                source: include_str!("..\\assets\\shader\\types.wgsl"),
                file_path: "..\\assets\\shader\\types.wgsl",
                language: naga_oil::compose::ShaderLanguage::Wgsl,
                shader_defs: shader_defs.clone(),
    ...
    pub fn load_naga_module_embedded(
        ...
        composer
            .make_naga_module(naga_oil::compose::NagaModuleDescriptor {
                source: include_str!("..\\assets\\shader\\utils\\testbed.wgsl"),
                file_path: "..\\assets\\shader\\utils\\testbed.wgsl",
                shader_defs,
                ..Default::default()
            })
    ...
    pub const SHADER_ENTRY_PATH: &str =
        include_absolute_path::include_absolute_path!("..\\assets\\shader\\utils\\testbed.wgsl");
    pub const MORESHADERFILESREACHME_PATH: &str = include_absolute_path::include_absolute_path!(
        "..\\assets\\shader\\utils\\..\\..\\more-shader-files\\reachme.wgsl"
    );
    pub const TYPES_PATH: &str =
        include_absolute_path::include_absolute_path!("..\\assets\\shader\\types.wgsl");
    pub const SHADER_PATHS: &[&str] = &[SHADER_ENTRY_PATH, MORESHADERFILESREACHME_PATH, TYPES_PATH];
...
"#;
    ...
    pub fn load_naga_module_embedded(
        ...
        composer
            .make_naga_module(naga_oil::compose::NagaModuleDescriptor {
                source: include_str!("..\\assets\\shader\\triangle.wgsl"),
                file_path: "..\\assets\\shader\\triangle.wgsl",
                shader_defs,
                ..Default::default()
            })
            .expect("failed to build naga module")
    ...
    pub const SHADER_ENTRY_PATH: &str =
        include_absolute_path::include_absolute_path!("..\\assets\\shader\\triangle.wgsl");
